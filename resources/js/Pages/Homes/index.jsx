    ...
    return (
        <div className="bg-gradient-to-b from-gray-50 to-white">
            ...
            <div className="min-h-screen mt-12 flex flex-col items-center justify-center">
                <PageContainer>
                    <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl w-full py-10 px-6 flex flex-col items-center text-center shadow-lg hover:shadow-xl transition-all duration-500 ease-in-out transform hover:scale-[1.01] animate-fade-in-up">
                    <h1 className="font-sans text-white text-3xl md:text-5xl font-semibold mb-2 animate-fade-in">
                        Experience a new way of learning with {BRAND_CONSTANTS.NAME.FULL}
                    </h1>
                    <h2 className="font-sans text-white text-[19px] font-normal mb-2 animate-fade-in delay-100">
                        For students, teachers and professionals
                    </h2>

                    <div className="flex gap-3 mt-2 animate-fade-in delay-200">
                        <Link href="/homophone-check">
                            <button className="relative z-10 font-sans text-white font-semibold border-2 border-white rounded-2xl px-8 py-3 text-[18px] transition-all duration-300 ease-in-out hover:scale-110 hover:shadow-lg active:scale-95 hover:bg-white hover:text-blue-600 group shadow-sm">
                ...
                {/* CTA */}
                <PageContainer>
                    <section className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-6 md:p-8 text-white shadow-lg hover:shadow-xl transition-all duration-500 ease-in-out transform hover:scale-[1.01] w-full mb-12 animate-fade-in-up">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-3">
                        ...
                        <div className="flex flex-col sm:flex-row gap-2">
                            <a
                                href="/auth"
                                className="px-6 py-3 bg-white text-blue-600 hover:bg-blue-600 hover:text-white rounded-2xl font-semibold transition-all duration-300 ease-in-out hover:scale-110 hover:shadow-lg active:scale-95 text-center shadow-sm"
                            >
                                Get Started
                            </a>
                            {/* <a
