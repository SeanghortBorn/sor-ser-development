...
import DetailsModal from "@/Components/HomophoneChecks/DetailsModal";
import HistoryModal from "@/Components/HomophoneChecks/HistoryModal";
import HistoryDetailModal from "@/Components/HomophoneChecks/HistoryDetailModal";
import CompletionModal from "@/Components/HomophoneChecks/CompletionModal";
...
export default function Index({ articles: initialArticles = [], userRole }) {
    ...
    const handleSaveClick = async () => {
        if (canAccessLibrary === null) {
            console.warn("Permission check still in progress, please try again");
            return;
        }
