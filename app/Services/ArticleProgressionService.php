    ...
    public function getAllArticlesWithStatus($userId)
    {
        ...
        return $allArticles->map(function ($article) use ($userId) {
            ...
            return [
                ...
                'typing_mode_label' => $typingMode === 'nlp_only' ? 'NLP-only (Basic)' : 'NLP+LA (Full Features)',
                ...
                // All unlock criteria
                'min_completion_percentage' => $article->setting->min_completion_percentage ?? null,
                'min_typing_speed' => $article->setting->min_typing_speed ?? null,
                'min_typed_words_percentage' => $article->setting->min_typed_words_percentage ?? null,
